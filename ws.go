...
func usage(errmsg string) {
  fmt.Fprintf(os.Stderr,
    "%s\n\n"+
      "usage: %s <serviceCmd= server= user= password= database=>\n"+
      "       where <serviceCmd> is one of\n"+
